...
## How It Works
1. Load monthly startup expense data
2. Learn normal spending patterns
3. Detect unusually high cost months
4. Explain anomalies using recent history
...
2. Keep `startup_costs.csv` in the same folder
3. Run:
